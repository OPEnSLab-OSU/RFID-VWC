...
void loop()
{
  digitalWrite(5, LOW); //  3.3V rail enable
  digitalWrite(6, HIGH);  // 5V rail enable
  ...
  {
    button_flag=false;
    Serial.println("timer in period: ");
    Serial.println(timer);
    }
  ...
  //Loom.InterruptManager().interrupt_reset(12);
 // while (!button_flag);
